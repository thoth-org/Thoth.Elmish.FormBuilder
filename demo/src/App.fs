...
module FakeServer =
    ...
    let decoderAllowPublic : Decoder<bool> =
        decodeIntFromString
        |> Decode.andThen (
            function
            | 1 ->
        ...
        applyIfEditing
            ...
            (fun formState ->
                ...
                if isValid then
                    ...
                    { model with State = Editing (Form.setLoading true newFormState) }, Cmd.OfPromise.either createProfile body CreateResponse OnError
                else
